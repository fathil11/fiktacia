...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('admin.index" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> | FIKTACIA 2019</span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo base_url();?>assets/images/hmti.png" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <img src="<?php echo base_url();?>assets/images/hmti.png" class="img-circle" alt="User Image">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="http://hmti.dinus.ac.id">HMTI UDINUS </a>.</strong> All rights
...
function cariAcara() {
  ...
  input = document.getElementById("jenis_acara");
